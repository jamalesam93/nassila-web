...
function FeatureMock({ variant }: { variant: (typeof FEATURE_KEYS)[number] }) {
  const images: Partial<Record<(typeof FEATURE_KEYS)[number], string>> = {
    verify: '/media/ui-bibliography.png',
    manuscript: '/media/ui-loop.png',
    export: '/media/banner.png',
  }
  const src = images[variant] ?? '/media/banner.png'
