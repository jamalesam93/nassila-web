...
**Nassila 2.0.0** (app installer) is separate from **Sanad 9B** (model checkpoint). **FT** = **full-text** checkpoint label — not your app semver. Current Hub tier: **FT-6 / v119**.
</Callout>
...
**5.0.0 One Nassila** is a routed pack of independently gated artifacts, **not** one merged multi-worker GGUF. Today, production grounding uses the **Sanad 9B** GGUF above.
