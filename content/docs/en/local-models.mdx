...
|------------|----------|------|----------------|--------------|
| `nassila-sanad-9b` | **FT-5** | Sole tier (Qwen 3.5) — pick your quant | Q2_K ~3.6 GB → Q8_0 ~8.9 GB | [nassila-sanad-9b](https://huggingface.co/QinEmPeRoR93/nassila-sanad-9b) |

Six GGUFs (**Q2_K / Q3_K_M / Q4_K_M / Q5_K_M / Q6_K / Q8_0**) share the same trained weights — pick the largest your memory allows. Typical filenames: `nassila-sanad-9b-q4_k_m.gguf`, `nassila-sanad-9b-q6_k.gguf`.
...
|-----------|------------|-------------|
| **9B** | FT-5 | Sole Sanad tier — you pick the quant |
