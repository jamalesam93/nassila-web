...
**Per-reference PDF attach** is live (**1.3.0** / **1.6.0**): attach from a finding or bibliography row, then re-audit that reference. Open-access PDF text from Unpaywall is also used when available (**Masdar-lite**, **1.2.0**). Folder-scan bulk attach is planned for **1.10.0 Masdar Papers**.
...
- **Shahid** (tables/figures) remains disabled until **2.0.0**. Maktab ingest and Masdar attach are live.
