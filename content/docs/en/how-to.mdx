...
- **Wayback Machine archive integration:** Nassila automatically generates fallback web archive links (`web.archive.org/web/*/...`) and surfaces an inline `[Wayback ↗]` action for link preservation and dead-link protection.
